...
/*= RECTANGLE PARALLELES AUX AXES                                             =*/
  ...
  void g2x_FillRectangle_Tex(double xd, double yd, double xu, double yu, uchar* TEX, int nbl, int nbc);
/*= TRIANGLES                                                                 =*/
...
/*= QUADRILATERES QUELCONQUES (ABCD)                                          =*/
  ...
  void g2x_FillQuad_Tex(double xa, double ya,double xb, double yb,
