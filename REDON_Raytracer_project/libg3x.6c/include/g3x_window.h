/* ===============================================================
  ...
  /*= récup-re les param. géométrique de la caméra =*/
  ...
  /* **************************************************************************** */
  int g3x_CreateScrollh_d(const char *nom, double* prm, double min, double max, double mapfactor, const char *info);
  /* meme chose pour un parametre entier (TYPE INT)                               */
  int g3x_CreateScrollh_i(const char *nom, int*    prm, int    min, int    max, double mapfactor, const char *info);
  ...
  int g3x_CreateScrollv_d(const char *nom, double* param, double min, double max, double mapfactor, const char *info);
  int g3x_CreateScrollv_i(const char *nom, int*    prm, int      min, int    max, double mapfactor, const char *info);
  int g3x_CreateAnonymousScrollv(const char *name, double init, const char *info);
