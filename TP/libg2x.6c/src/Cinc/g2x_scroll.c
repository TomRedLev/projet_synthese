...
extern int g2x_CreateScrollh_d(const char *name, double* prm, double min, double max, double mapfactor, const char *info)
{
...
extern int g2x_CreateScrollh_i(const char *name, int* prm, int min, int max, double mapfactor, const char *info)
{
	G2Xscroll *scroll=NULL,*s;
	if (scrollhnum>=BLOCSIZE)
	{ fprintf(stderr,"\e[36m<g2x_CreateScrollh> :\e[1;31mNOMBRE MAX (%d)ATTEINT retour -1\e[0;0m\n",scrollhnum); return -1;}
...
extern int g2x_CreateScrollv_d(const char *name, double* prm, double min, double max, double mapfactor, const char *info)
{
	G2Xscroll *scroll=NULL;
...
extern int g2x_CreateScrollv_i(const char *name, int* prm, int min, int max, double mapfactor, const char *info)
{
	G2Xscroll *scroll=NULL;
	if (scrollvnum>=BLOCSIZE)
	{ fprintf(stderr,"\e[36m<g2x_CreateScrollv> :\e[1;31mNOMBRE MAX (%d)ATTEINT retour -1\e[0;0m\n",scrollvnum); return -1;}
