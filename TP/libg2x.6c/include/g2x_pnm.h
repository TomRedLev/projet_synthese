/* ===============================================================
  ...
  /* avec G2X_MPEG_SETUP, les tailles sont ajustées au chargement (bords coupés)   */
  #define G2X_MPEG_SETUP    true
  #define G2X_NO_MPEG_SETUP false

  /* avec G2X_NO_RELOAD : lorsqu'une image est charchée, son nom est stocké dans un */
  ...
  /* Le principe est donc de ne déclarer que des G2Xpnm* initialisés à NULL        */
